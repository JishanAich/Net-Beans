 ...
 * @author Jishan Aich
 */
public class MagicPad extends javax.swing.JFrame {

    /**
     * Creates new form MagicPad
     */
    BufferedWriter bw;
    BufferedReader br;
    FileWriter writer;
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        fd.setFile("*.txt");
        fd.setDirectory("D");   
        fd.setVisible(rootPaneCheckingEnabled);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MagicPad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
